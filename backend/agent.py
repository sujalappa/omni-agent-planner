    ...
    def process_query(
        ...
        for step_idx in range(max_iterations):
            ...
            planner_prompt = (
                ...
                "- If the query/files/history already provide enough information to determine the task (e.g., 'summarize this video', 'what does this code do', 'what are the action items', 'fetch transcript'), you MUST NOT ask a clarifying question. Choose type='tool_call' and run the tools immediately. Do not clarify if there is no ambiguity.\n\n"
                "Available Tools:\n"
                ...
                "- conversational_answer: Answer general questions or simple context queries that don't need "
                "summarization, sentiment, or code explaining tools. Args: {'query': str}\n\n"
                f"{history_context}"
